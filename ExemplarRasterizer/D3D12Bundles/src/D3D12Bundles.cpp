...
void D3D12Bundles::LoadPipeline()
{
    ...
    m_Rasterizer->AssignDescriptorsStart(
        CD3DX12_CPU_DESCRIPTOR_HANDLE(m_cbvSrvHeap->GetCPUDescriptorHandleForHeapStart(), RasterizerDescriptorCount, mCbvSrvUavDescriptorSize),
        CD3DX12_GPU_DESCRIPTOR_HANDLE(m_cbvSrvHeap->GetGPUDescriptorHandleForHeapStart(), RasterizerDescriptorCount, mCbvSrvUavDescriptorSize),
...
void D3D12Bundles::LoadAssets()
{
    ...
    //Create compute root signature
    {
        ...
        slotRootParameter[3].InitAsDescriptorTable(1, &cbvTable);
        ...
        m_device->CreateRootSignature(0,
            ...
            IID_PPV_ARGS(m_rootSignatureCompute.GetAddressOf()));
    }
...
void D3D12Bundles::OnRender()
{
    ...
    //TODO Pass depth buffer to compute shader
